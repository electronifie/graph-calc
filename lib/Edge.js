...
var Edge = function (options) {
  ...
  this.toNode.on('deleted', this.delete.bind(this));
  this.fromNode.on('deleted', this.delete.bind(this));
...
Edge.prototype.delete = function () {
  this.toNode.removeListener('deleted', this.delete.bind(this));
  this.fromNode.removeListener('deleted', this.delete.bind(this));
