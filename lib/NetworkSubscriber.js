...
/**
 * @callback NodeEventSubscriberCb
 * @param {Node} node
 * @param {...*} eventArguments
 */

/**
 * @callback EdgeEventSubscriberCb
 * @param {Edge} edge
 * @param {...*} eventArguments
 */

/**
 * Subscribe to events within a {@link Node}'s network.
 *
 * Where a "network" is the entire graph, or a subgraph constructed from traversal options.
 *
 * @param {Object} options
 * @param {Node} options.node the root node.
 * @param {Object.<EventName, NodeEventSubscriberCb>} options.nodeEvents callbacks for {@link Node} emitted events.
 * @param {Object.<EventName, EdgeEventSubscriberCb>} options.edgeEvents callbacks for {@link Edge} emitted events.
 * @param {NodeType[]} [options.onlyNodeTypes] only include {@link Node}s of this type in the network.
 * @param {EdgeType[]} [options.onlyEdgeTypes] only include {@link Edge}s of this type in the network.
 * @param {NodeType[]} [options.excludeNodeTypes] exclude {@link Node}s of this type from the network.
 * @param {EdgeType[]} [options.excludeEdgeTypes] exclude {@link Edge}s of this type from the network.
 * @param {Number} [options.maxDepth=Infinity] nodes in the network should not be further than this distance from the root node.
 * @constructor
 */
